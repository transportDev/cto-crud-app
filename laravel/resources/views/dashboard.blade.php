...
<head>
    ...
    @vite(['resources/css/app.css', 'resources/css/dashboard.css', 'resources/js/app.js', 'resources/js/pages/dashboard.js'])
        ...
        <div class="grid grid-cols-1 md:grid-cols-[240px_minmax(0,1fr)] gap-4 items-start">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <x-chart-card id="trafficChart" title="S1 DL Rata-rata">
                        <x-slot name="header">
